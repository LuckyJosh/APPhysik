...
\subsection{Messung des Photostroms für die Spektrallinien von Quecksilber}
		...
		\input{Tabellen/Messwerte_Orange}
		\input{Tabellen/Messwerte_Gruen}
		\input{Tabellen/Messwerte_Cyan}
		\input{Tabellen/Messwerte_Violett1}
		\input{Tabellen/Messwerte_Violett2}
		...
		\input{Tabellen/Messwerte_Parameter}
	...
	\subsection{Messung der Abhängigkeit des Photostroms von der Bremmsspannung}
		...
		\end{figure}
		\input{Tabellen/Messwerte_Messung2}
