\textsc{\color{green}Einleitung nicht Vergessen}  

\subsection{Aufbau der Schaltung}
%	\cref{fig:AufbauSig1} und \ref{fig:AufbauSig2} zeigen die Veränderung des, vom Oszilloskop angezeigten Signals 
%	beim sukzessiven Aufbau der Schaltung.
...
%		\end{figure}
	...
	\input{Daten/Tabelle_ohneNoise.tex}
...
\subsection{Messung mit Noise-Generator}
	...
	\input{Daten/Tabelle_mitNoise.tex} 
...
\subsection{Messung der Intensität einer LED in Abhängigkeit  \\des Abstands}
	...
	\input{Daten/Tabelle_Abstand.tex}
