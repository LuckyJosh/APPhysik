...
\subsection{Messung der mittleren Reichweite im Abstand 20mm}\label{sec:Messung_I}
	...
	$R_{m} = \SI{6.56(1)}{\milli\meter}$. Durch Umstellen der \cref{eq:} kann aus diesem Wert 
...
\subsection{Messung der mittleren Reichweite im Abstand $25$\si{\mm}}\label{sec:Messung_II}
	...
	in \cref{fig:Messdaten_II_Energie}, ist es möglich mit einem der Bethe-Bloch-Gleichung \cref{eq:} 
