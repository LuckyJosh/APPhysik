...
\subsection{Bestimmung der I-U-Kennlinie}
	...
	jeweils in den Abbildungen \ref{fig:Auswertung_Leistung_30mA}, \ref{fig:Auswertung_Leistung_50mA},
	 \ref{fig:Auswertung_Leistung_75mA} und \ref{fig:Auswertung_Leistung_100mA} dargestellt.
		...
		\input{Tabellen/Intensitaet_Leistung.tex}
		\input{Tabellen/Kennlinie_30mA.tex}
		\input{Tabellen/Kennlinie_50mA.tex}
		\input{Tabellen/Kennlinie_75mA.tex}
		\input{Tabellen/Kennlinie_100mA.tex}
 
	
		\includeFigure[scale=0.65]{Grafiken/Kennlinie_30mA.pdf}{Grafische Darstellung der Messwerte der %
		    $I\text{-}U$-Kennlinie im Abstand \SI{81.5}{\cm}}{\label{fig:Auswertung_Kennlinie_30mA}}	
		\includeFigure[scale=0.7]{Grafiken/Leistung_30mA.pdf}{Grafische Darstellung der Leistung der Solarzelle %
		 in Abhängigkeit des Lastwiderstands, im Abstand \SI{81.5}{\cm}}{\label{fig:Auswertung_Leistung_30mA}}	
		...
		\includeFigure[scale=0.7]{Grafiken/Leistung_50mA.pdf}{Grafische Darstellung der Leistung der Solarzelle %
		in Abhängigkeit des Lastwiderstands, im Abstand \SI{60.5}{\cm}}{\label{fig:Auswertung_Leistung_50mA}}			
		...
		\includeFigure[scale=0.7]{Grafiken/Leistung_75mA.pdf}{Grafische Darstellung der Leistung der Solarzelle %
		in Abhängigkeit des Lastwiderstands, im Abstand \SI{48.0}{\cm}}{\label{fig:Auswertung_Leistung_75mA}}	
 		...
 		\includeFigure[scale=0.7]{Grafiken/Leistung_100mA.pdf}{Grafische Darstellung der Leistung der Solarzelle %
 		in Abhängigkeit des Lastwiderstands, im Abstand \SI{40.0}{\cm}}{\label{fig:Auswertung_Leistung_100mA}}	
