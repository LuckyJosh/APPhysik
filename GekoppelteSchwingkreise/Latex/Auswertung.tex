...
\subsection{Messung des Verlauf des Stroms $I_{2}$} \label{sec:Auswertung_Wobbel}
	...
	\end{figure}	
%	
%%		\subfloat[$C_{K} = \SI{2.86(9)}{\nano\farad}$\label{fig:C2}] {\includegraphics[scale=0.4]{Grafiken/Stromverlauf2.pdf}}\\
%		\subfloat[$C_{K} = \SI{4.7(1)}{\nano\farad}$\label{fig:C3}] {\includegraphics[scale=0.5]{Grafiken/Stromverlauf3.pdf}}\\
%%		\subfloat[$C_{K} = \SI{6.9(2)}{\nano\farad}$\label{fig:C4}] {\includegraphics[scale=0.4]{Grafiken/Stromverlauf4.pdf}}\\
%		\subfloat[$C_{K} = \SI{8.2(2)}{\nano\farad}$\label{fig:C5}] {\includegraphics[scale=0.5]{Grafiken/Stromverlauf5.pdf}}
%%		\subfloat[$C_{K} = \SI{10.0(3)}{\nano\farad}$\label{fig:C6}] {\includegraphics[scale=0.4]{Grafiken/Stromverlauf6.pdf}}\
%		\subfloat[$C_{K} = \SI{12.0(4)}{\nano\farad}$\label{fig:C7}] {\includegraphics[scale=0.5]{Grafiken/Stromverlauf7.pdf}}
%
%	
