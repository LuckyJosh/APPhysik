...
\usepackage[backend=biber, style=numeric-verb, sorting=none]{biblatex}							% Ermöglicht das Einbinden von Literaturverzeichnissen 	
...
\newcounter{errorEquation}
\renewcommand{\theerrorEquation}{\Roman{errorEquation}}
\newenvironment{errorEquation}{\refstepcounter{errorEquation}\equation}{\tag{\theerrorEquation}\endequation}
\newenvironment{errorEquationAlign}{\refstepcounter{errorEquation}\align}{\tag{\theerrorEquation}\endalign}

\usepackage{colortbl}
\usepackage{multirow}
\usepackage{adjustbox}

% Eigener Figuren Befehl
