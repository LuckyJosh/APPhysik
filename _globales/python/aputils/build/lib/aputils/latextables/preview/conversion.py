...
class Converter:
    ...
    def __init__(self, tablepath=None, tableobj=None, quiet=True):
    ...
    def _dviToPngFile(self):
        ...
        cdir = _ChDir(self._temppath + "\\" +
                      self._tempfoldername + "\\" + self._id)
        os.system("latex {} {}".format("temp.tex", self._quietMode()))
        os.system("dvipng -T tight -D 240 -o temp.png {} {}".format("temp", self._quietMode()))
        del cdir
