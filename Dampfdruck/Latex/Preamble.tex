...
\setlength{\parindent}{4mm}                                                         % Setzt die Einrückung von Absätzen auf gegebenen Abstand
...
\lhead{\textbf{Anfängerpraktikum Physik\\ \VNr\ \VN}}                                                                   % Angabe Links-Oben
...
% % % %\setlength{\skip\footins}{2.5 cm}                                                      % Abstand zwischen Text und Fußnoten
...
%\usepackage{subeqn}
%\renewcommand{\thesubequation}{\arabic{mainequation}.\arabic{equation}}
%\fancypagestyle{Toc}{%
%	\fancyhf{} %
%	\lhead{\textbf{\VNr\ \VN}} %                                  
%	\rhead{\VD} %                                
%	\rfoot{\Namen}}% Angabe Rechts-Unten
