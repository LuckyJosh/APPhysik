...
\centering
\hfill
\subfloat[Kapazitätsmessbrücke \label{pic:Kapazitaet}]{\includegraphics[scale=0.33]{Grafiken/Kapazitaet}}
\hfill
\subfloat[Induktivitätsmessbrücke \label{pic:Induktivitaet}]{\includegraphics[scale=0.31]{Grafiken/Induktivitaet}}
\hfill
...
\centering
\hfill
\subfloat[Maxwell-Brücke \label{pic:Maxwell}]{\includegraphics[scale=0.3]{Grafiken/Maxwell}}
\hfill
\subfloat[Wien-Robinson-Brücke \label{pic:WienRobinson}]{\includegraphics[scale=0.3]{Grafiken/WienRobinson}}
\hfill
