...
\subsection{Direkte Bestimmung der Ruhewellenlänge}
	...
	\input{Daten/Tabelle_Wellenlaenge.tex}   
...
\subsection{Bestimmung der Wagengeschwindigkeiten}
	...
	\input{Daten/Tabelle_Fahrtzeiten.tex}
	...
	\input{Daten/Tabelle_Geschwindigkeiten.tex} 
...
\subsection{Bestimmung von Ruhefrequenz und Schallgeschwindigkeit}
	...
	\input{Daten/Tabelle_Ruhefrequenz.tex}	
...
\label{sec:Auswertung_Direkt}
	...
	\input{Daten/Tabelle_Direkt.tex}
	...
	\input{Daten/Tabelle_DirektDifferenzen.tex}  
...
\subsection{Beurteilung der Messergebnisse durch einen t-Test}
	...
	\begin{empheq}{equation}
		...
		s = \sqrt{\dfrac{(n_{x} - 1)  \sigma_{x}^{2} + (n_{y} - 1)  \sigma_{y}^{2}}{(n_{x} - 1) + (n_{y} - 1)} \cdot 
