...
\subsection{Messung der Zeitkonstante durch Entladung des\\ Kondensators}
	...
	\end{figure}
    \input{Daten/Tabelle_Entladen.tex}
...
\label{sec:Auswertung_Amplitude}
	...
	\input{Daten/Tabelle_Amplituden.tex}
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[scale=0.70]{Grafiken/Amplitude.pdf}
...
\label{sec:Auswertung_Phasendifferenz}
	...
	\input{Daten/Tabelle_Phasendifferenz.tex}
	\begin{figure}[!h]
		\centering
		\includegraphics[scale=0.7]{Grafiken/Phasendifferenz.pdf}
