...
\begin{document}
  ...
  \section{Diskussion}
    ...
    da die drei Spannungen, also Trosions-, Elastizitäts- und Kommpressionsmodul, wie für den mit diesen Größen weniger vertrauten
    zu erwarten ist, ungefähr von der gleichen Größenordnung sind. Einzig die Negativität des Kompressionsmoduls ist auch für den 
    unvertrauten wenig sinnvoll.\\
    
    Diese Eindücker werden im Vergleich mit den Literaturwerten aus\,\cite{Kuchling07} bestätigt. Ausgehend von dem Elastizitätsmodul,
    ...
    Eisen mit $E_{lit,Fe} = \SI{211}{\giga Nm^{-2}}$ aber noch in der angegebenen Standatrdabweichung liegt.\\
    Im Vergleich zu den Literaturwerten für den Baustahl zeigt sich für das Torsionsmodul $G_{lit,Stahl} =\SI{85}{\giga Nm^{-2}}$ eine 
    geringere Abwiechung nach oben, wohingegen das Kompressionsmodul sehr stark vom Literaturwert $Q_{lit,Stahl} =\SI{167}{\giga Nm^{-2}}$
    ...
    Da alle dieser Abweichungen, außer die des Kompressionsmoduls nach oben handelt es sich hierbei um eine systematischen Fehler,
    wobei die Abweichung des Kompressionsmoduls nach unten duch die Abweichung der Querkontraktionszahl zu begründen sind.
    ...
    Aufgrund der bereits erwähnten Unzuverlässigkeit der Versuchapparatur war es nicht möglich die Periodendauer der
