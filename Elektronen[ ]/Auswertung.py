...
print("Mittelwert:",Umean([f_sin_err[0], f_sin_err[1], f_sin_err[2], f_sin_err[3]]))
print("Mittelwert_std:",np.std(noms(np.array([f_sin_err[0], f_sin_err[1], f_sin_err[2], f_sin_err[3]]))) / 2)
...
print("Mittelwert_std:", np.std(noms([Q_spez_1_err, Q_spez_2_err, Q_spez_3_err]))/2e11, "e+11")
